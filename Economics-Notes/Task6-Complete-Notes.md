...
**Complete study notes** (long version).
...
│   └── Non-produced, non-financial assets  (brand names, copyrights, trademarks,
│                                            rights to use land/water)
└── FINANCIAL ACCOUNT
...
So: Australians buy foreign shares → Australia gains an asset → **debit**.
Money leaves an Australian bank account to pay for imports → Australia loses an asset → **credit**.
...
**Affecting BOGS:**
1. Major trading partner growth (esp. China) ↑ → X ↑ → credits ↑ → BOGS ↑ → CAB ↑
2. Domestic growth ↑ → income ↑ → consumption + capital M ↑ → debits ↑ → BOGS ↓ → CAB ↓
3. AUD depreciates → X cheaper, M dearer → (if elastic) X ↑, M ↓ → BOGS ↑ → CAB ↑
4. TOT ↑ → X prices up relative to M prices → credits ↑ → BOGS ↑ → CAB ↑
5. International competitiveness ↑ (relative wages, inflation differential, exchange rate) → X ↑ → BOGS ↑ → CAB ↑
6. External shocks (commodity price swings, COVID, wars, tariffs)

**Affecting net primary income (NPY):**
1. Size of the **savings–investment gap** — the main reason
2. Level of accumulated foreign liabilities (debt + equity)
3. Global and domestic interest rates → interest payable on foreign debt
4. Profitability of foreign-owned Australian firms → dividends payable
...
**Rise = FAVOURABLE.** XPI rises relative to MPI. Purchasing power ↑ — we buy **more** imports per unit of exports.
**Fall = UNFAVOURABLE.** MPI rises relative to XPI. Purchasing power ↓ — we buy **fewer** imports per unit of exports.
...
- **Commodity prices** (~75% of exports). Demand *and* supply are **inelastic** → steep curves → small shifts cause **large** price swings. Biggest driver of the TOT.
...
- **Manufactured goods prices** (most of our imports). Supply is **elastic** → flat supply curve → prices stable and trending down (Chinese manufacturing, productivity, ICT technology). Falling MPI → TOT ↑.
...
Same volume of exports earns more revenue →

- BOGS/trade balance ↑ → CAB ↑
- Real GDP and **national income** ↑ → living standards ↑
- Company profits ↑ → investment and employment in the resources sector ↑ → unemployment ↓
- Government tax revenue ↑ (company tax, royalties) → budget position improves
- Demand for AUD ↑ → **AUD appreciates**
...
|---|---|
| *Systematic record* | An organised set of accounts, not a random list. Compiled by the ABS. |
| *All transactions* | Goods, services, income, transfers **and** financial flows. |
| *Residents of Australia* | Defined broadly: people who live here, businesses that operate here, the Australian government, and other organisations operating here. **Not** citizenship. |
| *Over a given period* | Monthly, quarterly or annually — it's a **flow** measure, not a stock. |
...
| **Financial derivatives** | Purchase/sale of financial contracts whose value is *derived* from another instrument (a bond, share, exchange rate, market index) | These transactions involve the exchange of **risk** between parties, rather than funds |
...
**The 10% rule is a classic MCQ.** ≥10% = direct investment. <10% = portfolio investment.
...
**Current account = the spending and earning wallet.**
Money in = exports and foreign income (credits). Money out = imports and income paid to foreigners (debits). Spending more than you earn → **current account deficit**.

**Financial account = the borrowing and investing wallet.**
To cover the gap you borrow money or attract investment from others (capital inflow = credit). That gives you a **financial account surplus**.
...
*Step 1 — net goods:*
```
Net goods = goods credits − goods debits = 600 − 500 = +100
```

*Step 2 — build the CAB:*
```
CAB = net goods + net services + net income
    = 100 + (−300) + net income
    = −200 + net income
```
...
**Transactions:**
- Sale of $5,000 of iron to China
- Sale of $2,000 of shares to a US investor
- Purchase of $10,000 of TVs from Korea

**Working:**
- Iron: CR $5,000 in CA (goods); offsetting DR $5,000 in FA (import of currency)
- Shares: CR $2,000 in FA; offsetting DR $2,000 in FA (import of currency)
- TVs: DR $10,000 in CA (goods); offsetting CR $10,000 in FA (export of currency)
...
**Transactions:**
- Sale of an Australian farm worth $25k to a Chinese investor
- Australian tourists spend $15k overseas
- Australia sells $50k of LNG to Korea
- Australia purchases Indian telecomms businesses for $80k

| | Credit | Debit | Totals |
|---|---|---|---|
| **Current account** | +$50,000 (LNG) | −$15,000 (Australian tourists) | **+$35,000** |
| **Capital and financial account** | +$25,000 (farm)<br>+$15,000 (currency)<br>+$80,000 (currency) | −$25,000 (currency)<br>−$50,000 (currency)<br>−$80,000 (Indian business) | **−$35,000** |
...
4. **Mixing up direct and portfolio investment.** ≥10% voting power = direct.
...
CAB = BOGS (trade balance)  +  Net primary income  +  Net secondary income
        ↑ volatile, swings between                    ↑ persistently
          surplus and deficit                          in DEFICIT
```
...
|---|---|
| **Size of the S–I gap** | Bigger gap → more foreign borrowing/equity → **larger** NPY deficit. *The main driver.* |
...
> 3. To solve this, Australia:
>    - **Borrows from overseas** → creates **foreign debt**
>    - **Sells ownership of Australian assets** → creates **foreign equity**
...
- If **I > S** → the gap must be funded by foreign capital → **CAD** (and a matching KAFA surplus)
- If **S > I** → Australia is a net lender to the world → **CAS** (and a matching KAFA deficit)
...
- **Small population** → a small pool of domestic savings in absolute terms
...
*Current situation:*
- Low national savings creates the S–I gap
- The S–I gap creates the need for foreign borrowing and equity
- This creates NPY outflows, therefore decreasing the CAB

*What higher national savings would mean:*
- **Lower S–I gap**
- Firms could fund projects from **domestic savings instead of foreign capital**
- **Less need for foreign borrowing and equity**
- **Fewer NPY outflows** (interest, dividends, profits) → **lower NPY deficit** → **increases the CAB (shrinking the CAD)**

*And the mirror image:* less capital inflow needed → **smaller KAFA surplus**, consistent with CAB + KAFA = 0.
...
S–I gap
      ↓
Foreign borrowing (debt) + selling assets (equity)   ←──┐
      ↓                                                 │
Stock of foreign liabilities grows                      │
      ↓                                                 │
Servicing costs rise (interest + dividends)             │
      ↓                                                 │
NPY deficit widens                                      │
      ↓                                                 │
CAD widens ─────────────────────────────────────────────┘
...
**Worked illustration — XPI.** Australia exports mostly iron ore, coal and LNG. China's construction sector booms and needs a lot of steel, so demand for Australian iron ore rises sharply. Demand-pull pressure drives the world price of iron ore from $100 to $150 per tonne. Meanwhile LNG prices stay about the same and coal prices rise slightly due to a colder winter in Asia. Because **iron ore has a big weight in the index**, that large price increase pushes the whole XPI up even though other export prices barely change. On average, Australia is now **receiving more money per unit of exports**. If import prices stay the same, the **TOT improves** — Australia can buy more imports for the same amount of exports.
...
Year 2:  115/110 × 100 = 104.5   → TOT improves
Year 3:  102/108 × 100 =  94.4   → TOT deteriorates
```
...
```
2015:  (103/117) × 100 = 88.0
2020:  (109/119) × 100 = 91.6
```

*Step 2 — calculate the percentage increase:*
```
(91.6 − 88.0) / 88.0 × 100 ≈ 4.1%
```
...
3. For every other year: `(total that year ÷ total in base year) × 100`
...
```
Year 1 (base):  420/420 × 100 = 100
Year 2:         410/420 × 100 = 97.6  ≈ 98
Year 3:         470/420 × 100 = 111.9 ≈ 112
```

**What does the XPI mean?** Calculate the rate of change to find the percentage increase or decrease:

```
Year 1 → Year 2:   98 − 100  = a fall of 2%
Year 2 → Year 3:  112 −  98  = a 14% rise
```

*Note the subtlety:* because the base year is 100, the change **from the base year** in index points happens to equal the percentage change — that's why Year 1 → Year 2 is a clean −2%. But Year 2 → Year 3 is **not** a 14% rise; 14 is the change in **index points**. The percentage change is `14 ÷ 98 × 100 = 14.3%`. The class slide quotes 14% as a points change — if the question says "calculate the percentage change", use 14.3%. See the trap in section 4.2.
...
```
Y1 → Y2:  (95.5 − 100)  / 100  × 100 = −4.5%  → UNFAVOURABLE
Y2 → Y3:  (97.4 − 95.5) / 95.5 × 100 = +2.0%  → FAVOURABLE
...
- The rise in **per cent** = 1.9 ÷ 95.5 × 100 = **2.0%**
...
```
% change in TOT  ≈  % change in XPI  −  % change in MPI
```

Example: XPI +1.1%, MPI +5.7% → TOT ≈ 1.1 − 5.7 = **−4.6%**, i.e. a fall.
(The exact figure is 1.011/1.057 − 1 = **−4.35%** — the approximation is close enough to pick the right MCQ option, but use the full formula if you're asked to *calculate*.)
...
| **Effects** | Trade balance/BOGS (X−M) **increases**<br>Real GDP and national income **increase**<br>Unemployment rate **decreases**<br>Government tax revenue **increases**<br>Living standards **rise**<br>Investment and employment in the resources sector **rise**<br>AUD **appreciates** (more demand for our currency)<br>Inflation rate **increases** | Trade balance/BOGS (X−M) **decreases**<br>Real GDP and national income **decrease**<br>Unemployment rate **increases**<br>Government tax revenue **decreases**<br>Living standards **fall**<br>Investment and employment in the resources sector **fall**<br>AUD **depreciates** (less demand for our currency)<br>Inflation rate **decreases** |
...
*Sources: [ABS Balance of Payments and International Investment Position](https://www.abs.gov.au/statistics/economy/international-trade/balance-payments-and-international-investment-position-australia/latest-release); [ABS media release — current account deficit widens](https://www.abs.gov.au/media-centre/media-releases/current-account-deficit-widens); [ABS media release — first trade deficit since December 2017](https://www.abs.gov.au/media-centre/media-releases/first-trade-deficit-december-2017). Content summarised and rephrased for licensing compliance.*
...
**XPI falling:**
- World commodity prices start to fall
- **Increased supply** on global commodity markets and **falling global demand as growth slows in China** → decreased commodity prices
- **Iron ore fell from US$180 per tonne to US$40 per tonne (2011 to 2015)**
- **Fall in global oil prices** — in the last quarter of 2015 oil dropped from **US$48 to US$32 (a 33% fall)**, due to weak demand and the end of trade sanctions against Iran leading to rising supply. This led to a fall in the price of Australia's **energy substitutes** such as coal and natural gas
...
**XPI rising (40%):**
- World economic growth increased → **rise in commodity prices**, particularly **coal and iron ore** due to strong growth in China
- **Rise in oil prices (substitution effect):** members of the **OPEC cartel** (which controls global supply of oil) stabilised oil prices by stabilising supply, leading to an increase in global oil prices → increased demand for **oil substitutes** → **increased XPI (LNG)** → **increase in TOT**

**MPI rising, but by less than the XPI:**
- Rise in oil prices — one of Australia's major imports
- Somewhat **offset by lower manufacturing prices** (thus smaller MPI movements)
...
**XPI fell:**
- COVID caused a **global recession** → XPI falling
- Fall in **LNG and coal prices** due to reduced global energy demand (travel restrictions)

**MPI fell:**
- Fall in **oil prices** due to a significant reduction in demand during lockdowns (one of Australia's major import costs)
- Weak global demand for consumption and manufactured goods due to uncertainty/sentiment
- **Strong AUD** in the latter half of 2020 → makes imported goods cheaper/more affordable

#### 2020–2022: TOT RISING to a historic high

**XPI rising** (after the fall in the June–Sept quarters of 2020):
- **Rise in commodity prices**, especially **coal and gas** — caused by rising demand for exports as economies began to recover from the 2020 recessions and invest, build and grow → need raw materials → rise in commodity prices
- **Rise in oil prices** — in March 2022 petrol prices were the highest in a decade, above **$2 per litre** — driven by strong global oil demand and constrained global supply (**Ukraine–Russia conflict**). Increased demand for oil substitutes → increased XPI → increased TOT

**MPI rising** (after falling through 2020):
- Import prices began to rise through 2021 due to **global supply constraints/shortages** forcing prices up
- Main contributors: **petroleum, road vehicles and fertilisers**
...
**XPI falling:**
- **Fall in commodity prices**, especially **iron ore**
- Caused by the **economic slowdown in China** (less demand for Australian exports) → decreased XPI → **reduced purchasing power**
- Current global factors: the **US announced tariffs on Australian steel and aluminium exports**, which may lead to a further downturn and fall in the XPI

**MPI falling:**
- Prices of **oil and petroleum fell by 17.7%** (March quarter 2024) — weaker global demand
- **High inflation in Australia (7% in 2023)** → slowdown in the economy → decrease in consumption and imports
...
```
% change in TOT ≈ %ΔXPI − %ΔMPI = 1.1 − 5.7 = −4.6%
...
- **XPI weakness** in commodities: **metalliferous ores and metal scrap fell 1.4%**, weighed down by **high Chinese iron ore stockpiles** and **strong global supply conditions**, with **Chinese steel production incentives falling** and **anti-dumping measures softening iron ore demand**
...
- RBA Explainer — *[Trends in Australia's Balance of Payments](https://www.rba.gov.au/education/resources/explainers/trends-in-australias-balance-of-payments.html)*
- RBA Chart Pack — *[Balance of Payments and External Position](https://www.rba.gov.au/chart-pack/balance-payments.html)*
- ABS — *[Balance of Payments and International Investment Position, Australia](https://www.abs.gov.au/statistics/economy/international-trade/balance-payments-and-international-investment-position-australia/latest-release)*
- ABS — *[International Trade Price Indexes, Australia](https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation/international-trade-price-indexes-australia/latest-release)*

---

# 05 — Practice Questions

20 multiple choice + 12 short answer + 3 data-response sets. **Do them closed-book first.** Answers and full working are in [Part D](#part-d--answers).

---

## Part A — Multiple choice

**1.** The balance of payments is best defined as:
- (a) A record of Australia's exports and imports of goods and services
- (b) A systematic record of all transactions between Australian residents and the rest of the world over a period of time
- (c) A measure of Australia's total foreign debt at a point in time
- (d) The difference between Australia's national savings and national investment

**2.** An Australian mining company imports new excavators from Japan. This is recorded as a:
- (a) Debit in the financial account under direct investment
- (b) Credit in the capital account
- (c) Debit in the current account under goods
- (d) Debit in the financial account under other investment

**3.** A German company purchases 30% of the ordinary shares in an Australian agricultural business. This is recorded in the:
- (a) Financial account as a credit under portfolio investment
- (b) Financial account as a credit under direct investment
- (c) Capital account as a credit under capital transfers
- (d) Financial account as a debit under direct investment

**4.** Australia's balance of payments must always sum to zero because:
- (a) The ABS adjusts the figures to make them balance
- (b) Exports always equal imports over the long run
- (c) Every transaction is recorded as two equal and opposite entries
- (d) The RBA intervenes in the foreign exchange market to offset any imbalance

**5.** If Australia's capital and financial account records a surplus of $18.4 billion, the current account must record:
- (a) A surplus of $18.4 billion
- (b) A deficit of $18.4 billion
- (c) A balance of zero
- (d) It cannot be determined without more information

**6.** An Australian resident deposits $50,000 into a bank account in Singapore. In the KAFA this is recorded as a:
- (a) Credit, because money has flowed out of Australia
- (b) Debit, because Australia's foreign assets have increased
- (c) Credit, because Australia's liabilities have increased
- (d) Debit, because Australia's liabilities have decreased

**7.** Which of the following is recorded in the **capital** account?
- (a) An Australian firm purchasing a factory in Vietnam
- (b) An Australian company buying the rights to use a foreign brand name in Australia
- (c) An overseas investor purchasing Australian government bonds
- (d) The RBA purchasing foreign currency reserves

**8.** The item "net errors and omissions" is included in the balance of payments because:
- (a) The ABS makes arithmetic errors when compiling the accounts
- (b) Some transactions are difficult to measure accurately or are not recorded at all
- (c) Exchange rate movements change the value of transactions after they occur
- (d) Illegal transactions are excluded from the accounts by law

**9.** An Australian university receives $30,000 in fees from an Indonesian student studying in Melbourne. The two entries are:
- (a) Credit in the current account (services) and debit in the financial account
- (b) Debit in the current account (services) and credit in the financial account
- (c) Credit in the current account (primary income) and debit in the financial account
- (d) Credit in the capital account and debit in the current account

**10.** Australia's net primary income has remained in deficit for decades primarily because:
- (a) Australia consistently imports more goods than it exports
- (b) Australia is a net capital importer and must service its foreign liabilities
- (c) Australia provides large amounts of foreign aid
- (d) Australian wages are higher than those of our trading partners

**11.** An increase in Australia's rate of economic growth, other things equal, would be expected to:
- (a) Increase BOGS and increase the CAB
- (b) Decrease BOGS and decrease the CAB
- (c) Increase BOGS and decrease the CAB
- (d) Have no effect on the CAB

**12.** The terms of trade index is calculated as:
- (a) (Import price index ÷ export price index) × 100
- (b) (Export price index ÷ import price index) × 100
- (c) (Export volume ÷ import volume) × 100
- (d) Export values minus import values

**13.** Australia's terms of trade will improve if:
- (a) Both export and import prices rise by the same percentage
- (b) Export prices fall and import prices fall by a smaller percentage
- (c) Export prices rise and import prices rise by a smaller percentage
- (d) Export volumes rise and import volumes fall

**14.** In a given year Australia's XPI is 124 and its MPI is 110. The terms of trade index is closest to:
- (a) 88.7
- (b) 112.7
- (c) 114.0
- (d) 134.0

**15.** Australia's terms of trade index falls from 120 to 114. This represents:
- (a) A fall of 6%
- (b) A fall of 5%
- (c) A fall of 6 per cent and 6 index points
- (d) A fall of 5.3%

**16.** A key reason commodity prices are highly volatile is that:
- (a) Demand is elastic and supply is elastic
- (b) Demand is inelastic and supply is elastic
- (c) Both demand and supply are inelastic, so small shifts cause large price changes
- (d) Commodities are traded only under long-term fixed-price contracts

**17.** Australia's terms of trade is more closely correlated with the XPI than the MPI because:
- (a) Exports are a larger share of GDP than imports
- (b) The supply of manufactured goods is more elastic than the supply of primary commodities
- (c) The ABS gives exports a greater weighting in the terms of trade index
- (d) Import prices are fixed by long-term contracts

**18.** A sustained fall in Australia's terms of trade would most likely lead to:
- (a) An appreciation of the AUD and rising national income
- (b) A depreciation of the AUD and falling national income
- (c) Stronger economic growth in Australia
- (d) An improvement in national economic welfare

**19.** Australia's XPI rises by 3% while its MPI rises by 8% over the same period. It follows that:
- (a) The terms of trade rose by approximately 5%
- (b) The terms of trade fell by approximately 5%
- (c) The value of Australia's exports fell
- (d) Australia's export volumes must have fallen

**20.** If Australia's national savings rate increased significantly, other things equal, we would expect:
- (a) A larger S–I gap, a wider NPY deficit and a lower CAB
- (b) A smaller S–I gap, a narrower NPY deficit and a higher CAB
- (c) A smaller S–I gap and a larger KAFA surplus
- (d) No change to the current account, since savings affect only the financial account
...
**(a)** Calculate the terms of trade index for each year. *(3 marks)*
**(b)** Calculate the percentage change in the terms of trade between 2023 and 2024. *(2 marks)*
**(c)** Calculate the percentage change in the terms of trade between 2024 and 2025. *(2 marks)*
**(d)** State whether the movement in (c) was favourable or unfavourable, and explain what it means for Australia's purchasing power. *(3 marks)*
**(e)** Give one likely reason for the movement in the terms of trade between 2024 and 2025. *(2 marks)*
...
**(d)** Calculate the current account balance. *(2 marks)*
**(e)** State the value of the capital and financial account balance and explain your reasoning. *(2 marks)*
**(f)** With reference to the data, explain the main reason for the current account outcome. *(3 marks)*
...
| **2** | **(c)** | Excavators are **imported goods**, so a goods debit in the current account. Capital *goods* are still goods — this is the classic trap. The offsetting entry would be a credit in the financial account. |
| **3** | **(b)** | 30% ≥ 10%, so **direct** investment. It's a **credit** because Australia's liabilities to the rest of the world have increased (foreigners now own part of an Australian business). |
| **4** | **(c)** | The double-entry book-keeping system. Note (a) is wrong: net errors and omissions is a *measurement* balancing item, not the reason the accounts balance in principle. |
...
| **14** | **(b)** | 124 ÷ 110 × 100 = **112.7**. (a) is the inverted formula — a deliberate distractor. |
| **15** | **(b)** | (114 − 120) ÷ 120 × 100 = **−5%**. It is a fall of 6 index *points* but 5 *per cent*, so (a) and (c) are wrong. |
...
| **19** | **(b)** | ≈ 3 − 8 = **−5%** (exact: 1.03/1.08 − 1 = −4.6%). (c) and (d) are the classic "you can't infer values or volumes from price indexes" traps. |
...
**(a)** *(3 marks)*
```
2023:  (120 ÷ 110) × 100 = 109.1
2024:  (132 ÷ 115) × 100 = 114.8
2025:  (126 ÷ 120) × 100 = 105.0
```

**(b)** *(2 marks)*
```
(114.8 − 109.1) ÷ 109.1 × 100 = +5.2%
```
> The terms of trade **rose by approximately 5.2%**.

**(c)** *(2 marks)*
```
(105.0 − 114.8) ÷ 114.8 × 100 = −8.5%
```
...
**(a)** Net goods = 450 − 380 = **+$70m** *(1 mark)*

**(b)** Net services = 90 − 130 = **−$40m** *(1 mark)*

**(c)** BOGS = 70 + (−40) = **+$30m** *(1 mark)*
...
| **Capital and financial account** | +$15,000 (shares)<br>+$6,000 (currency)<br>+$25,000 (currency) | −$25,000 (patent)<br>−$40,000 (currency)<br>−$15,000 (currency) | **−$34,000** |
| **Totals** | **+$86,000** | **−$86,000** | **$0** |

**Check:** CA (+$34,000) + KAFA (−$34,000) = **$0** ✓

**Marks to note:**
- 3% < 10% → **portfolio**, not direct investment
- A patent is an **intangible, non-produced non-financial asset** → **capital** account, not financial account
- Every transaction needs **two** entries
- The table must sum to zero
...
| **Describe** | Say *what* happened — direction, magnitude, dates. |
| **Distinguish** | Both items, with an explicit point of difference ("whereas…"). |
| **Explain** | Say *why*, using a **causal chain**. |
...
- Marks ≈ minutes for short answer. A 6-mark question deserves roughly 6 minutes and 6 distinct points.
...
# Task 6 — Past Exam Questions, Worked

These are the actual past exam questions from your class slides (the "PAST EXAM QUESTIONS" sections of the Terms of Trade deck, plus the BOP data-response practice). The question stems were images, so they weren't in the earlier notes. Answers worked in full below.

**Do them covered up first.** These are the closest thing you have to the real test.

## Multiple choice

**Q1.** The table shows data for a nation's terms of trade.
...
Which statement about this nation's terms of trade is correct?
(A) Improved from Year 1 through to Year 3 · (B) Deteriorated from Year 1 through to Year 3 · (C) Deteriorated Y1→Y2 then improved Y2→Y3 · (D) Improved Y1→Y2 then deteriorated Y2→Y3

---

**Q2.** The table shows the volume and price of exports and imports for two years.

| Year | X volume | X price | M volume | M price |
|---|---|---|---|---|
| 1 | 100 | 100 | 100 | 100 |
| 2 | 105 | 110 | 110 | 105 |

How have the terms of trade and the volume of net exports changed?
(A) Risen / Increased · (B) Fallen / Decreased · (C) Fallen / Increased · (D) Risen / Decreased

---

**Q3.** This question refers to the table below.
...
For this economy in Year 3:
(a) the current account has improved · (b) there has been an increase in the volume of exports · (c) the terms of trade have deteriorated · (d) the terms of trade have improved

---

**Q4.** What is the main consequence of a fall in an economy's TOT?
(a) An appreciation of the Australian dollar · (b) A widening of the current account deficit · (c) Stronger economic growth in Australia · (d) An improvement in national economic welfare

---

**Q5.** A decrease in Australia's terms of trade will:
(a) increase national income and increase the trade balance · (b) increase national income and decrease the trade balance · (c) decrease national income and increase the trade balance · (d) decrease national income and decrease the trade balance

---

**Q6.** The table shows selected economic data for a hypothetical economy.

| Balance of payments categories | $ billion |
|---|---|
| Export of goods | 340 |
| Import of goods | 316 |
| Export of services | 58 |
| Import of services | 61 |
| Net income | −164 |

Which statement is correct?
(a) The balance on goods and services is $27 billion · (b) The goods balance is $340 billion · (c) The current account deficit is $164 billion · (d) The current account deficit is $143 billion

---

**Q7.** If Australia recorded a current account surplus:
(a) there would be a reduced need for foreign investment · (b) net foreign liabilities would begin increasing rapidly · (c) Australian residents would need to sell more assets to overseas residents · (d) the capital account must record a deficit

---

**Q8.** An increase in direct foreign investment in Australian agriculture would be recorded in Australia's balance of payments as a credit in the:
(a) current account · (b) capital account · (c) financial account · (d) national savings account

---

**Q9.** *(adjacent topic — see the note at the end)* The table shows the production possibilities of coal and iron ore in two countries.
...
According to the table, country:
(a) B has a comparative advantage in producing coal · (b) A has an absolute advantage in producing iron ore · (c) B has a comparative advantage in producing iron ore · (d) A has a comparative advantage in producing iron ore

## Data response — 12 marks

Refer to the table below relating to the Australian economy.

| Year | G&S credit ($m) | G&S debit ($m) | Net income balance ($m) | Current account balance ($m) | Annual growth rate (%) |
|---|---|---|---|---|---|
| 2014 | 81,327 | −88,238 | −9,883 | −16,794 | 2.6 |
| 2015 | 82,717 | −94,022 | −12,345 | −23,650 | 2.8 |
| 2016 | 83,588 | −89,868 | −9,327 | −15,607 | 2.4 |
| 2017 | 97,376 | −89,494 | −13,486 | **?** | 1.8 |

*Source: ABS*

**(a)** Calculate: **(i)** the Balance of Goods and Services for 2017; **(ii)** the Current Account Balance for 2017. *(2 marks)*

**(b)** Explain **two structural** reasons for the change in the net income balance from 2016 to 2017. *(5 marks)*

**(c)** Explain the relationship between the annual economic growth rate and the Balance of Goods and Services. *(5 marks)*
...
**Q1 — (A).** Calculate the TOT each year:

```
Year 1: 100/100 × 100 = 100.0
Year 2: 110/106 × 100 = 103.8   ← rose
Year 3: 115/110 × 100 = 104.5   ← rose again
```
The TOT rose in both periods, so it improved from Year 1 through to Year 3. **Trap:** in Year 3 the XPI rose 5 points and the MPI rose 4 points — both rose, so you must actually compute the ratio rather than eyeball it.

**Q2 — (D) Risen / Decreased.** This question deliberately gives you volumes *and* prices, and you need different columns for each half.

```
TOT (prices only):  Y1 = 100/100 × 100 = 100
                    Y2 = 110/105 × 100 = 104.8   → RISEN
Net export VOLUME:  Y1 = 100 − 100 = 0
                    Y2 = 105 − 110 = −5          → DECREASED
```
Export volume rose 5% but import volume rose 10%, so net exports fell even though the terms of trade improved. **This is the single most instructive question in the set** — it separates the **price effect** (TOT) from the **volume effect** (net exports). Don't use price data for a volume question or vice versa.

**Q3 — (d) the terms of trade have improved.**

```
Year 1: 100/100 × 100 = 100.0
Year 2: 110/120 × 100 =  91.7
Year 3: 120/125 × 100 =  96.0
```
**The trap is (c).** Year 3 (96.0) is still *below* Year 1 (100), so it's tempting to say "deteriorated". But the question asks about the change **in Year 3**, i.e. from Year 2 — and 91.7 → 96.0 is a **rise**. (a) and (b) are the classic "you cannot infer values or volumes from price indexes" distractors: with no quantity data you can say nothing about the current account or export volumes.

**Q4 — (b) A widening of the current account deficit.** A fall in the TOT means export prices fall relative to import prices, so export credits fall relative to import debits → BOGS falls → the CAD widens. Why the others fail: (a) a falling TOT causes a **depreciation**, not an appreciation, as demand for AUD falls; (c) a falling TOT **reduces** growth prospects; (d) it **reduces** national economic welfare by cutting real purchasing power from trade.

**Q5 — (d) decrease national income and decrease the trade balance.** Same mechanism: lower export prices relative to import prices → lower export revenue → **trade balance falls**; that lost revenue is lost income to exporters → **national income falls**. Both go the same way, which rules out (b) and (c) immediately.

**Q6 — (d) The current account deficit is $143 billion.**

```
Net goods    = 340 − 316 = +24
Net services =  58 −  61 =  −3
BOGS         =  24 −   3 = +21
CAB          =  21 + (−164) = −143   → deficit of $143 billion
```
Why the others fail: (a) BOGS is $21b, not $27b; (b) $340b is *exports of goods*, not the goods *balance* (which is $24b); (c) $164b is the *net income* deficit, not the CAD.

**Q7 — (d) the capital account must record a deficit.** From the identity **CAB + KAFA = 0**, a current account surplus must be exactly offset by a capital and financial account **deficit**. Why the others fail: (b) is backwards — a CAS means net foreign liabilities stop growing, not grow rapidly; (c) describes what happens under a *deficit*.

> **Be aware:** option (a) — "reduced need for foreign investment" — is also economically true, since a CAS means savings exceed investment. The reason (d) is the keyed answer is the word **"must"**: (d) follows necessarily from the accounting identity, whereas (a) is an economic implication. Note also that the question says "capital account" loosely to mean the whole **capital and financial account**.

**Q8 — (c) financial account.** Direct investment is a **financial account** component. It's a **credit** because Australia's liabilities to the rest of the world increase. **The trap is (b)** — the *capital* account is the small, separate part that records capital transfers and non-produced non-financial assets (brand names, copyrights, mining rights). Investment in a business goes in the **financial** account.

**Q9 — (c) B has a comparative advantage in producing iron ore.** Compare opportunity costs:

```
Country A:  1 coal costs 100/50 = 2 iron ore  |  1 iron ore costs 50/100 = 0.5 coal
Country B:  1 coal costs 320/80 = 4 iron ore  |  1 iron ore costs 80/320 = 0.25 coal
```
Lower opportunity cost wins. **Coal:** A (2 iron ore) beats B (4) → **A** has the comparative advantage in coal. **Iron ore:** B (0.25 coal) beats A (0.5) → **B** has it in iron ore. So (a) and (d) are wrong. (b) is wrong because B produces more of **both** goods, so B has the absolute advantage in both.

## Data response

**(a)(i)** *(1 mark)*
```
BOGS 2017 = G&S credit − G&S debit = 97,376 − 89,494 = +$7,882m  (a surplus)
```

**(a)(ii)** *(1 mark)*
```
CAB 2017 = BOGS + net income = 7,882 + (−13,486) = −$5,604m  (a deficit of $5,604m)
```
*Check your method on a row where the answer is given: 2016 → (83,588 − 89,868) + (−9,327) = −6,280 − 9,327 = −15,607 ✓ matches the table. The method is sound.*

**(b) Two structural reasons for the widening net income deficit, 2016 → 2017** *(5 marks)*

The net income balance moved from −$9,327m to −$13,486m, a **widening of the deficit by $4,159m**. Note the question asks for **structural** reasons — fundamental factors affecting the **income balance**, not cyclical ones.

> **1. The savings–investment gap.** Australia has a small population and a relatively low national savings rate, creating a gap between intended investment and available domestic savings. Australia closes this gap by **borrowing overseas (foreign debt)** and **selling ownership of Australian assets (foreign equity)**. Both generate **servicing obligations** — interest on debt and dividends and profits on equity — recorded as **primary income debits**. As the gap persisted through this period, continued capital inflow added to these outflows, widening the net income deficit.
>
> **2. The growing stock of accumulated foreign liabilities.** Because Australia has run persistent current account deficits funded by capital inflow, the **stock** of foreign debt and foreign equity has accumulated over time. A larger stock mechanically requires larger interest and dividend payments each year. In addition, much of Australia's capital stock — particularly **mining, which is largely foreign-owned** — became more profitable in 2017 as commodity prices recovered (visible in the 16.5% jump in G&S credits), so **higher profits meant higher dividends paid to overseas investors**, further widening the primary income deficit.

**(c) The relationship between the annual growth rate and BOGS** *(5 marks)*

> There is an **inverse relationship**. When Australia's growth rate rises, national income rises, so households increase consumption spending — particularly on **discretionary and luxury** goods — increasing **consumption imports**. Firms simultaneously increase production and output, increasing imports of **capital and intermediate goods**. Both raise **debits** in the balance on goods and services, **reducing BOGS**. When growth slows, income falls, households cut discretionary spending and firms reduce capital imports, so debits fall and **BOGS improves**.
>
> **The data support this.** The highest growth rate in the period, **2.8% in 2015**, coincided with the **largest BOGS deficit (−$11,305m)**, driven by G&S debits peaking at $94,022m. Conversely the **lowest growth rate, 1.8% in 2017**, coincided with BOGS moving into a **surplus of $7,882m**, with debits falling to $89,494m.
>
> **Qualification worth a mark:** the 2017 improvement was not caused by weaker growth alone. G&S **credits rose sharply from $83,588m to $97,376m (16.5%)**, reflecting a recovery in commodity prices and a rising terms of trade. So while the inverse growth–BOGS relationship holds, export prices were the larger driver in 2017.

| Year | Growth | BOGS |
|---|---|---|
| 2014 | 2.6% | −$6,911m |
| 2015 | **2.8%** | **−$11,305m** (worst) |
| 2016 | 2.4% | −$6,280m |
| 2017 | **1.8%** | **+$7,882m** (best) |

---

## A note on Q9 and scope

**Q9 is comparative advantage**, which is **not** one of the five dot points in your task statement. It appeared in the past-exam set your teacher included, which mixes questions from across the trade topic. I've worked it because it's cheap insurance, but don't spend study time there at the expense of the five listed points.

The same applies to the exchange rate. It appears *inside* your topic as a **factor affecting BOGS and the TOT** — which is covered — but exchange rate determination itself is a separate syllabus point and isn't listed in your task.
